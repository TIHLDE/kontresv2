...
export default function AuthTester() {
    ...
    const { data: adminData, isSuccess: adminSuccess } =
    ...
    return (
        <SessionProvider>
            ...
            <Card className="p-5 my-5">
                <h1>Admin Data</h1>
                {!adminSuccess && (
                    <p className="text-red-500">Failed to fetch admin data</p>
                )}
                {adminSuccess && (
                    <>
                        <p className="text-green-500">
                            Successfully fetched admin data
                        </p>
            ...
            <Card className="p-5 my-5">
                <h1>Member Data</h1>
                {!memberSuccess && (
                    <p className="text-red-500">Failed to fetch member data</p>
                )}
                {memberSuccess && (
                    <>
                        <p className="text-green-500">
